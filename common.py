...
def help_menu(ssh_handler):
    ...
    ssh_handler.send_message("look - with no parameters it will observe the room. With a parameter is will provide information about an object, enemy or character in the same room or in the inventory.")
    ssh_handler.send_message("2. Sign Up")
    ssh_handler.send_message("3. Settings")
    ssh_handler.send_message("4. Exit")
    return 0
